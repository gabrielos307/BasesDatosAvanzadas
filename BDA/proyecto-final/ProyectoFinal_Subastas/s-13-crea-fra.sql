...
alter system set db_recovery_file_dest='/disk_6/app/oracle/oradata/FLHEPROY/flash_recovery_area' scope=both;
...
--Online redo log
alter system set db_create_online_log_dest_3='/disk_6/app/oracle/oradata/FLHEPROY/flash_recovery_area/FLHEPROY' scope=both;
